...
To make <b>Alexa on MCU</b> possible, FT900 (Alexa client) communicates with a <b>Raspberry PI 3B/3B+</b> (Alexa gateway), which relays voice requests and voice responses to and from the Alexa cloud. 
