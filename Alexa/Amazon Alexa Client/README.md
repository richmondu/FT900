...
To make <b>Alexa on MCU</b> possible, FT900 (Alexa client) communicates with a <b>Raspberry PI 3B/3B+</b> (Alexa gateway), 
which relays voice requests and voice responses to and from the Alexa cloud. 
The RPI which runs a customized version of Amazon’s official open-source <b>[Alexa Voice Service (AVS) SDK](https://github.com/alexa/avs-device-sdk)</b>, allows <b>multiple FT900 microcontrollers</b> to simultaneously access Alexa using <b>single or multiple Amazon accounts</b>. 
