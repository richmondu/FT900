...
where users can issue voice commands to Alexa and hear Alexa’s voice responses generated by Alexa’s complex <b>speech recognition</b>, <b>natural language processing</b> and <b>speech synthesis</b> in the cloud. 
...
Below are the action items for the Alexa Demo.
      ...
      3. Implement "ESP32 Alexa Client".
      4. RPI should also send Alexa "Display Cards" to FT900 since FT900 can be connected to a FT800 display.
      5. Integrate "FT900 libMAD MP3 decoder" and provide RPI option to send MP3 instead of PCM/raw.
