...
#elif (USE_SAMPLING_RATE == SAMPLING_RATE_16KHZ)
extern __flash__ uint8_t raw_audio[]        asm("response_16k_raw");
extern __flash__ uint8_t raw_audio_end[]    asm("response_16k_raw_end");
