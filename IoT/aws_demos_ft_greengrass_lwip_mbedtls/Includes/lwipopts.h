...
#ifdef FT32_FREERTOS
// 14-Jun-16, TODO, use FreeRTOS malloc() and free().
...
/* MEMP_NUM_RAW_PCB: the number of RAW connection protocol control blocks. One
 ...
 * Default 8.
 */
#define MEMP_NUM_TCPIP_MSG_API          2//8
 ...
 * Default 8.
 */
#define MEMP_NUM_TCPIP_MSG_INPKT        2//8
 ...
 */
#define TCPIP_THREAD_STACKSIZE          192//256//368
 ...
 * to sys_mbox_new() when the recvmbox is created.
 */
#define DEFAULT_UDP_RECVMBOX_SIZE       4//32       //Queue Size (4byte/slot)
 ...
 * to sys_mbox_new() when the recvmbox is created.
 */
#define DEFAULT_TCP_RECVMBOX_SIZE       4//32      //Queue Size (4byte/slot)
 ...
 */
#define DEFAULT_ACCEPTMBOX_SIZE         4//32      //Queue Size (4byte/slot)
