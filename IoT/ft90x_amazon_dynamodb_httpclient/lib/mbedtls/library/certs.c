...
"-----END CERTIFICATE-----\r\n"
__flash__ const char mbedtls_test_ca_crt_ec[] = TEST_CA_CRT_EC;
const size_t mbedtls_test_ca_crt_ec_len = sizeof( mbedtls_test_ca_crt_ec );

__flash__ const char mbedtls_test_ca_key_ec[] =
...
__flash__ const char mbedtls_test_ca_pwd_ec[] = "PolarSSLTest";
const size_t mbedtls_test_ca_pwd_ec_len = sizeof( mbedtls_test_ca_pwd_ec ) - 1;

__flash__ const char mbedtls_test_srv_crt_ec[] =
"-----BEGIN CERTIFICATE-----\r\n"
...
__flash__ const char mbedtls_test_srv_key_ec[] =
"-----BEGIN EC PRIVATE KEY-----\r\n"
...
__flash__ const char mbedtls_test_cli_crt_ec[] =
"-----BEGIN CERTIFICATE-----\r\n"
...
__flash__ const char mbedtls_test_cli_key_ec[] =
"-----BEGIN EC PRIVATE KEY-----\r\n"
...
__flash__ const char   mbedtls_test_ca_crt_rsa[]   = TEST_CA_CRT_RSA_SHA256;
const size_t mbedtls_test_ca_crt_rsa_len = sizeof( mbedtls_test_ca_crt_rsa );
#define TEST_CA_CRT_RSA_SOME

static __flash__ const char mbedtls_test_ca_crt_rsa_sha256[] = TEST_CA_CRT_RSA_SHA256;
...
__flash__ const char   mbedtls_test_ca_crt_rsa[]   = TEST_CA_CRT_RSA_SHA1;
const size_t mbedtls_test_ca_crt_rsa_len = sizeof( mbedtls_test_ca_crt_rsa );
#endif

static __flash__ const char mbedtls_test_ca_crt_rsa_sha1[] = TEST_CA_CRT_RSA_SHA1;

#endif

__flash__ const char mbedtls_test_ca_key_rsa[] =
...
__flash__ const char mbedtls_test_srv_key_rsa[] =
"-----BEGIN RSA PRIVATE KEY-----\r\n"
...
__flash__ const char mbedtls_test_cli_crt_rsa[] =
"-----BEGIN CERTIFICATE-----\r\n"
...
__flash__ const char mbedtls_test_cli_key_rsa[] =
"-----BEGIN RSA PRIVATE KEY-----\r\n"
...
__flash__ const char mbedtls_test_cas_pem[] =
...
__flash__ const char * mbedtls_test_cas[] = {
...
#if defined(MBEDTLS_RSA_C)
__flash__ const char *mbedtls_test_ca_crt  = mbedtls_test_ca_crt_rsa; /* SHA1 or SHA256 */
__flash__ const char *mbedtls_test_ca_key  = mbedtls_test_ca_key_rsa;
__flash__ const char *mbedtls_test_ca_pwd  = mbedtls_test_ca_pwd_rsa;
__flash__ const char *mbedtls_test_srv_crt = mbedtls_test_srv_crt_rsa;
__flash__ const char *mbedtls_test_srv_key = mbedtls_test_srv_key_rsa;
__flash__ const char *mbedtls_test_cli_crt = mbedtls_test_cli_crt_rsa;
__flash__ const char *mbedtls_test_cli_key = mbedtls_test_cli_key_rsa;
...
__flash__ const char *mbedtls_test_ca_crt  = mbedtls_test_ca_crt_ec;
__flash__ const char *mbedtls_test_ca_key  = mbedtls_test_ca_key_ec;
__flash__ const char *mbedtls_test_ca_pwd  = mbedtls_test_ca_pwd_ec;
__flash__ const char *mbedtls_test_srv_crt = mbedtls_test_srv_crt_ec;
__flash__ const char *mbedtls_test_srv_key = mbedtls_test_srv_key_ec;
__flash__ const char *mbedtls_test_cli_crt = mbedtls_test_cli_crt_ec;
__flash__ const char *mbedtls_test_cli_key = mbedtls_test_cli_key_ec;
