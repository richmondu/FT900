...
#define MQTT_TLS_NEGOTIATION_TIMEOUT  pdMS_TO_TICKS( 10000 )
#define MQTT_TIMEOUT                  pdMS_TO_TICKS( 10000 )
...
inline iot_status iot_subscribe( const iot_subscribe_params_t* param )
{
