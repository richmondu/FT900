...
#define CONFIG_AWS_ACCESS_KEY       ""
#define CONFIG_AWS_SECRET_KEY       ""

// Create FT900SNStopic on your AWS SNS console account
// and create email subscription to FT900SNStopic
#define CONFIG_AWS_SNS_TOPIC_ARN    ""
#define CONFIG_AWS_SNS_PHONE_NUMBER "+639175900612"

// Update based on your SNS region
#define CONFIG_AWS_REGION           "ap-southeast-1"
#define CONFIG_AWS_HOST             "sns.ap-southeast-1.amazonaws.com"
